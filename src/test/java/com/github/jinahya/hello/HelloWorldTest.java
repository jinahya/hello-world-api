...
public class HelloWorldTest {
    ...
    /**
     * Asserts the value of {@link HelloWorld#SIZE} constant equals to the length of {@code hello, world}
     * string in form of bytes encoded with {@link StandardCharsets#US_ASCII} character set.
     */
    @Test
